<template>
  <div class="flex flex-col">
    <label :for="inputId" class="capitalize font-HM font-light text-body text-ui-gray-900">{{ props.label }}</label>
    <div class="flex items-center px-1 h-10 rounded-md shadow-md bg-white" :class="borderStyle">
      ...
      <input v-model="textValue" :type="props.hiddenValue ? 'password' : 'text'" :id="inputId"
