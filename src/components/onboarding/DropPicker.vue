<template>
  <div class="flex relative items-center px-1 mb-1 h-10 rounded-md shadow-md bg-white">
    ...
    <select :value="gender" @click="toggleMenu" @change="updateGenderHandler"
    ...
    <img v-if="!menuIsOpen" src="../../assets/icons/chevron-down.svg" alt="Open select menu icon"
      class="absolute pointer-events-none right-1 w-6 h-6" />
    <img v-else src="../../assets/icons/chevron-up.svg" alt="Close select menu icon"
